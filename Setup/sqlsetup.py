...
sqlcommands = [
    ...
    "CREATE TABLE Video (id INT AUTO_INCREMENT PRIMARY KEY, old_id VARCHAR(6) UNIQUE,name VARCHAR(255) UNIQUE NOT NULL, channel_id INT NOT NULL, url VARCHAR(255) UNIQUE, , upload_date INT, status TINYINT NOT NULL DEFAULT 0)",
