...
sqlcommands = [
    ...
    "CREATE TABLE Video (id INT AUTO_INCREMENT PRIMARY KEY, old_id VARCHAR(6) UNIQUE, title VARCHAR(255) UNIQUE NOT NULL, channel_id INT NOT NULL, shoot_timestampt INT, edit_timestamp INT, upload_timestamp INT, status TINYINT NOT NULL DEFAULT 0, comment LONGTEXT DEFAULT NULL)",
