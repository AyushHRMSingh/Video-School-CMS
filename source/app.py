...
def get_stat_api(channel_id):
    ...
    if request_json['req_type'] == "default":
        ...
        time_range = request_json['time_range']
        # print('timedate changed to:', time_range)
        output = stat_functions_edited.get_likes(channel_id,time_range)
        return flask.jsonify(output)
        ...
        return flask.jsonify(output)
    elif request_json['req_type'] == "shares":
        time_range = request_json['time_range']
        # print('timedate changed to:', time_range)
        output = stat_functions_edited.get_shares(channel_id,time_range)
        return flask.jsonify(output)
    return "nonoe"
