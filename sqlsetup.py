...
sqlcommands = [
    ...
    "CREATE TABLE Video (ID INT AUTO_INCREMENT PRIMARY KEY, name VARCHAR(255) UNIQUE NOT NULL, channel_id INT NOT NULL, url VARCHAR(255) UNIQUE, creator_id INT, editor_id INT, manager_id INT, ops_id INT, upload_date INT, status TINYINT NOT NULL DEFAULT 0)",
